...
Software Engineering graduate with **10+ years** of professional experience
...
- 💬 Ask me about **bilingual customer support**, **community management**, or **digital marketing**
- 🌐 **Spanish** (native) · **English** (B2, actively improving)
- 📫 Reach me: [linkedin.com/in/davidalejandrosoler](https://linkedin.com/in/davidalejandrosoler)
- 🌍 Available worldwide — no location restrictions
...
### 📊 Marketing metrics dashboard *(in progress)*
Python script that analyzes social media KPIs and generates visual reports.
`Python` `Pandas` `Matplotlib`

### 📱 MiDiaEnOrden
Android app for daily task management — fragments and local storage.
`Android` `Java` `Mobile`
...
| | |
|---|---|
| ✅ Bilingual ES/EN | Native Spanish · English B2 |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/davidalejandrosoler)
[![Email](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:dasoler@gmail.com)
